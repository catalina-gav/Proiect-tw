...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:1234/proiect-tw/mvc/public/css/statistics.css">
</head>
    <header>
...
<body>
    <div class="statistic">
        <form class="button-area" action="login.html">
            <div class="formular">
          <button class="form-button" type="submit">Show Statistics</button>
          </div>
          <div class="formular">
          <button class="form-button" type="submit" formaction="formular_instiintare.html">Report</button>
          </div>
          </form>
    </div>
</body>
