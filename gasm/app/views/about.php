...
<body>
    <div class="about">
        ...
        <p class="paragraf">  GaSM (Garbage Smart Monitor) is an application that manages Maprmation on garbage collection, sorting and recycling at the level of the citizen and authorized personnel.
